...
const Banner = () => {
  return (
      <div className="flex flex-col h-[30vh] md:flex-row items-center w-full bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl overflow-hidden shadow-lg mb-30">
      {/* Text Content */}
